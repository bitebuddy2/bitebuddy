...
export const metadata: Metadata = {
  title: "Free AI Recipe Generator - Create Custom Recipes Instantly | Bite Buddy",
  description: "Turn any ingredients into delicious recipes with our free AI recipe generator. Get personalized meal ideas in seconds. Customize by cooking method, dietary needs, spice level & portions.",
  keywords: "AI recipe generator, recipe maker, meal ideas, cooking AI, recipe creator, custom recipes, ingredient-based recipes, meal planning AI",
  openGraph: {
    title: "Free AI Recipe Generator - Create Custom Recipes Instantly",
    description: "Turn any ingredients into delicious recipes with our free AI recipe generator. Get personalized meal ideas in seconds. Customize by cooking method, dietary needs, spice level & portions.",
    type: "website",
  },
  twitter: {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      ...
      <section className="mt-16 prose prose-lg max-w-4xl mx-auto">
        ...
        <p className="text-gray-700 mb-6">
          Ready to revolutionize your cooking? Simply enter your ingredients above and let our AI recipe generator create amazing meal ideas for you. It's completely free, requires no sign-up (for basic use), and delivers restaurant-quality results in seconds.
        </p>
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes! Our AI recipe generator is completely free to use. You get 1 free AI-generated recipe per day without signing up. Premium users get unlimited recipe generation."
                }
              },
              {
                "@type": "Question",
