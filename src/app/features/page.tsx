      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <p className="text-gray-700">
              Absolutely! Every recipe has a share button that lets you send it via WhatsApp, email, or social media. Your AI-generated recipes get a unique URL you can share with anyone.
            </p>
          </div>
