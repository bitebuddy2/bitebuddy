      ...
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4">
        ...
        <nav className="hidden md:flex items-center gap-4">
          ...
          <div className="relative group">
            <button className={`text-sm hover:text-emerald-400 transition-colors flex items-center gap-1 ${
              pathname === "/recipes" || pathname === "/community-recipes" ? "font-semibold text-white" : "text-gray-300"
            }`}>
              Recipes
            ...
            <div className="absolute top-full left-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[100]">
              ...
              <Link
                ...
                className={`block px-4 py-2.5 text-sm hover:bg-gray-700 rounded-b-lg transition-colors ${
                  pathname === "/community-recipes" ? "font-semibold text-white bg-gray-700" : "text-gray-300"
                }`}
              >
                Community Recipes
              </Link>
