...
DROP INDEX IF EXISTS idx_recipe_comments_recipe_slug;
DROP INDEX IF EXISTS idx_recipe_comments_ai_recipe_id;
DROP INDEX IF EXISTS idx_recipe_comments_user_id;
DROP INDEX IF EXISTS idx_recipe_comments_created_at;
